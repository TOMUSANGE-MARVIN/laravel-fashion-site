                ...
                <table class="table table-bordered align-middle">
                  ...
                  <tr>
                    <td colspan="3" class="text-end">
                      <button type="button" class="btn btn-primary" onclick="addSlide(this)">Add to</button>
                    </td>
                  </tr>
                </table>
              </div>
  ...
  <script>
    ...
    function getCountries() {
      axios.get('{{ front_route('countries.index') }}').then(function (res) {
        ...
        countrySelect.empty();
        countrySelect.append('<option value="">Please select country</option>');
    ...
    // Get provinces/states for selected country
    function getZones(countryId) {
      axios.get('{{ front_route('countries.index') }}/' + countryId).then(function (res) {
        ...
        zoneSelect.append('<option value="">Please select province/state</option>');

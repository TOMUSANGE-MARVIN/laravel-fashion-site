...
/* harmony import */ var _cart__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cart */ "./innopacks/front/resources/js/cart.js");
...
/* harmony import */ var _autocomplete__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./autocomplete */ "./innopacks/front/resources/js/autocomplete.js");
/* harmony import */ var _autocomplete__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_autocomplete__WEBPACK_IMPORTED_MODULE_6__);
...
/***/ "./innopacks/front/resources/js/cart.js":
/*!**********************************************!*\
  !*** ./innopacks/front/resources/js/cart.js ***!
  \**********************************************/
/***/ (() => {
...
function updateCartOffcanvasContent(data) {
  ...
  var offcanvasBody = cartOffcanvas.querySelector('.offcanvas-body');
  if (!offcanvasBody) {
  ...
  if (!data.list || !data.list.length) {
    ...
    offcanvasBody.innerHTML = "\n      <div class=\"text-center py-5\">\n        <img src=\"".concat(asset_url, "images/icons/empty-cart.svg\" class=\"img-fluid w-max-200 mb-4\">\n        <h5>").concat(translations.empty_cart || 'Your shopping cart is empty', "</h5>\n        <a class=\"btn btn-primary mt-3\" href=\"").concat(urls.base_url, "\">").concat(translations["continue"] || 'Continue Shopping', "</a>\n      </div>\n    ");
    return;
  }

  // Build cart items HTML
  var cartItemsHtml = '<div class="cart-items">';
  data.list.forEach(function (product) {
    cartItemsHtml += "\n      <div class=\"cart-item\" data-id=\"".concat(product.id, "\">\n        <div class=\"d-flex\">\n          <div class=\"cart-item-image\">\n            <img src=\"").concat(product.image, "\" class=\"img-fluid\">\n          </div>\n          <div class=\"cart-item-details ms-3\">\n            <div class=\"cart-item-name\">\n              <a href=\"").concat(product.url, "\">").concat(product.product_name, "</a>\n            </div>\n            <div class=\"text-secondary mt-1\">\n              ").concat(product.sku_code, "\n              ").concat(product.variant_label ? '- ' + product.variant_label : '', "\n            </div>\n            <div class=\"d-flex justify-content-between align-items-center mt-2\">\n              <div class=\"cart-item-price fs-5\">").concat(product.price_format, "</div>\n              <div class=\"quantity-wrap small-quantity mx-3\">\n                <div class=\"minus\"><i class=\"bi bi-dash-lg\"></i></div>\n                <input type=\"number\" class=\"form-control fs-6\" value=\"").concat(product.quantity || 1, "\">\n                <div class=\"plus\"><i class=\"bi bi-plus-lg\"></i></div>\n              </div>\n              <div class=\"delete-cart text-danger cursor-pointer\"><i class=\"bi bi-x-circle-fill fs-5\"></i></div>\n            </div>\n            <div class=\"d-flex justify-content-between align-items-center mt-2\">\n            </div>\n          </div>\n        </div>\n      </div>\n    ");
  });
  cartItemsHtml += '</div>';

  // Add cart summary
  cartItemsHtml += "\n    <div class=\"cart-summary mt-4\">\n      <div class=\"bg-light p-3 mb-4\">\n        <div class=\"d-flex justify-content-between\">\n          <span class=\"fs-5\">".concat(translations.total || 'Total', "</span>\n          <span class=\"fs-5 total-amount\">").concat(data.amount_format, "</span>\n        </div>\n      </div>\n      <a class=\"btn btn-primary btn-lg fw-bold w-100 to-checkout\" href=\"").concat(urls.checkout, "\">").concat(translations.go_checkout || 'Checkout', "</a>\n      <a class=\"btn btn-outline-secondary btn-lg fw-bold w-100 mt-2\" href=\"").concat(urls.cart, "\">").concat(translations.view_cart || 'View Cart', "</a>\n    </div>\n  ");
 ...
 */
function updateOffcanvasCart(id, quantity) {
  var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'put';
  axios[method]("".concat(urls.cart_add, "/").concat(id), {
    quantity: quantity
  }).then(function (response) {
    var res = response;
    if (res.success) {
      ...
      if (method === 'delete') {
        var cartItem = document.querySelector(".cart-item[data-id=\"".concat(id, "\"]"));
        if (cartItem) {
          cartItem.remove();
        }
        ...
        var item = res.data.list.find(function (item) {
          return item.id === id;
        });
        if (item) {
          var subtotalEl = document.querySelector(".cart-item[data-id=\"".concat(id, "\"] .cart-item-subtotal"));
          if (subtotalEl) {
...
function testCartMiniEndpoint() {
  ...
  fetch(urls.cart_mini).then(function (response) {
...
/***/ "./innopacks/install/resources/css/app.scss":
/*!**************************************************!*\
  !*** ./innopacks/install/resources/css/app.scss ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"/build/front/js/app": 0,
/******/ 			"build/install/css/app": 0,
/******/ 			"build/panel/css/app": 0,
/******/ 			"build/panel/css/bootstrap": 0,
/******/ 			"build/front/css/app": 0,
/******/ 			"build/front/css/bootstrap": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunklaravel_fashion_site"] = self["webpackChunklaravel_fashion_site"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["build/install/css/app","build/panel/css/app","build/panel/css/bootstrap","build/front/css/app","build/front/css/bootstrap"], () => (__webpack_require__("./innopacks/front/resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["build/install/css/app","build/panel/css/app","build/panel/css/bootstrap","build/front/css/app","build/front/css/bootstrap"], () => (__webpack_require__("./innopacks/front/resources/css/bootstrap/bootstrap.scss")))
/******/ 	__webpack_require__.O(undefined, ["build/install/css/app","build/panel/css/app","build/panel/css/bootstrap","build/front/css/app","build/front/css/bootstrap"], () => (__webpack_require__("./innopacks/front/resources/css/app.scss")))
/******/ 	__webpack_require__.O(undefined, ["build/install/css/app","build/panel/css/app","build/panel/css/bootstrap","build/front/css/app","build/front/css/bootstrap"], () => (__webpack_require__("./innopacks/panel/resources/css/bootstrap/bootstrap.scss")))
/******/ 	__webpack_require__.O(undefined, ["build/install/css/app","build/panel/css/app","build/panel/css/bootstrap","build/front/css/app","build/front/css/bootstrap"], () => (__webpack_require__("./innopacks/panel/resources/css/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["build/install/css/app","build/panel/css/app","build/panel/css/bootstrap","build/front/css/app","build/front/css/bootstrap"], () => (__webpack_require__("./innopacks/install/resources/css/app.scss")))
